...
<div>
            ...
            <v-layout justify-center align-center v-show="!loader">
                <v-layout row wrap>
                    <v-card>
                        <v-card-title>
                            Brand
                            <v-btn @click="openAdd" flat color="primary">Add Brand</v-btn>
                            <!-- <v-spacer></v-spacer> -->
                            <v-tooltip bottom>
                        ...
                        <v-data-table :headers="headers" :items="brands" class="elevation-1" :search="search" :loading="loading">
    ...
    <Edit @closeRequest="close" :openAddRequest="dispEdit" @alertRequest="showAlert" :brand="catEdit"></Edit>
...
export default {
    ...
    methods: {
        ...
        editProduct(task) {
            ...
            this.editedIndex = this.brands.indexOf(task);
            this.dispEdit = true;
        },
        getCategory() {
            this.loading = true;
