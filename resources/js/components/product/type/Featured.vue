        ...
        <v-card>
          ...
          <v-content>
            <div class="image-container">
              <img
                class="d-block w-100"
                :src="'/storage/products/'+props.item.image"
                alt="First slide"
                :class="{'selected': isSelected(props.item.id)}"
                @mouseover="hoverCard(props.item.id)"
                @mouseout="hoverCard(-1)"
              >

              <!-- <div class="after">This is some content</div> -->
              <div
                class="caption after text-center"
                :class="{'selected': isSelected(props.item.id)}"
              >
