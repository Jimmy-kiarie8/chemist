...
<div>
    <v-content>
        <v-container fluid fill-height>
            ...
            <v-layout justify-center align-center v-show="!loader">
                <v-layout row wrap>
                    <v-card>
                        <v-card-title>Subcategory
                            <v-btn @click="openAdd" flat color="primary">Add Subcategory</v-btn>
                            <!-- <v-spacer></v-spacer> -->
                            <v-tooltip bottom>
                        ...
                        <v-data-table :headers="headers" :items="subcategories" class="elevation-1" :search="search" :loading="loading">
                            ...
                            <template slot="items" slot-scope="props">
                                ...
                                <td class="justify-center layout px-0">
                                    <v-tooltip bottom>
                                        <v-btn slot="activator" icon class="mx-0" @click="editSubcat(props.item)">
    ...
    <Edit></Edit>
    <!-- <Edit @closeRequest="close" :openAddRequest="dispEdit" @alertRequest="showAlert" :subcategory="catEdit"></Edit> -->
...
export default {
    ...
    methods: {
        ...
        editSubcat(data) {
            ...
            //   this.editedIndex = this.subcategories.indexOf(task);
            //   this.dispEdit = true;
            eventBus.$emit("subCatEditEvent", data);
